...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG_type', type=str, default='gan', choices=['gan', 'diffusion'], help='generator type: gan (original two-stage) or diffusion (DDPM-based)')
        parser.add_argument('--diffusion_timesteps', type=int, default=1000, help='number of diffusion timesteps (only for diffusion model)')
        parser.add_argument('--diffusion_beta_schedule', type=str, default='linear', choices=['linear', 'cosine'], help='noise schedule for diffusion (only for diffusion model)')
