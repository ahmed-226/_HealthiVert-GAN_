...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--n_epochs_decay', type=int, default=800, help='number of epochs to linearly decay learning rate to zero')
        ...
        # --sample-test moved to base_options.py
